...
body {
  padding-top: 4em;
  background: url(~assets/images/background.png) top center fixed;
}
body.gray {
...
html.light body {
  background: url(~assets/images/background.png) top center fixed !important;
}
html.light img {
...
html.dark {
  ...
  --light-bg: #373737 !important;
  --light-font: #ddd !important;
}
html.dark body {
  background: #000 url(~assets/images/background-night.png) top center fixed !important;
}
html.dark img {
...
@media screen and (prefers-color-scheme: dark) {
  ...
  body {
    background: #000 url(~assets/images/background-night.png) top center fixed;
  }
  img {
...
.thanks-btn:before {
  ...
  content: '\f004';
  font-family: FontAwesome;
  animation: like-me 0.5s ease-in-out infinite alternate;
}
.paul-thanks h2 {
  margin-top: 0.5em;
  font-weight: 700;
...
.paul-note .note-inform span:before,
.paul-note .note-action span:before {
  margin-right: 0.5em;
  font-family: FontAwesome;
}
.note-inform .user:before {
  content: '\f007';
}
.note-inform .mood:before {
  content: '\f004';
}
.note-inform .music:before {
  content: '\f025';
}
.note-inform .weather:before {
  content: '\f0c2';
}
...
.gallery-item {
  ...
  position: relative;
  border-radius: 0.5em;
  background: #f3c694 center/cover url(~assets/images/load.gif);
...
footer:before {
  ...
  z-index: -1;
  position: absolute;
  background: url(~assets/images/footer.png) top/cover;
}
@media screen and (max-width: 600px) {
  footer {
    padding: 5em 0 2em;
