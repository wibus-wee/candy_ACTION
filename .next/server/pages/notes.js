...
module.exports = __webpack_require__("sWcX");
...
const NoteIndex = ({
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    antd_lib_message__WEBPACK_IMPORTED_MODULE_0___default.a.info('正在跳往至最新, 请等待');

    router.replace('/notes/[id]', `/notes/${latestNid}`, {
      shallow: true
    }); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);
  return __jsx("main", null);
};

const getStaticProps = async () => {
  return {
    props: {
      latestNid: core__WEBPACK_IMPORTED_MODULE_2__[/* Core */ "a"].fetcher.notes.tail.nid
    }
  };
};
