...
module.exports = __webpack_require__("MjEs");
...
// EXTERNAL MODULE: ./components/Action/index.module.scss
var index_module = __webpack_require__("PL58");
var index_module_default = /*#__PURE__*/__webpack_require__.n(index_module);

// CONCATENATED MODULE: ./components/Action/index.tsx
...
/* harmony default export */ var components_Action = (/*#__PURE__*/Object(external_react_["memo"])(function Action(props) {
  const {
    actions = [],
    informs = [],
    copyright = true
  } = props,
        rest = _objectWithoutProperties(props, ["actions", "informs", "copyright"]);

  return __jsx(external_react_default.a.Fragment, null, __jsx("div", _extends({
    className: "note-inform"
  }, rest), informs.map((inform, index) => {
    return __jsx("span", {
      key: index
    ...
    icon: free_brands_svg_icons_["faCreativeCommons"],
    className: index_module_default.a.icon
  })))), __jsx("div", {
...
// EXTERNAL MODULE: ./layouts/NoteLayout.tsx
var NoteLayout = __webpack_require__("dumg");
...
// CONCATENATED MODULE: ./pages/notes/[id].tsx
...
const NoteView = Object(mobx["a" /* observer */])(props => {
  const {
    content: text,
    created,
    modified,
  ...
  const {
    description,
    wordCount
  } = Object(utils["c" /* getSummaryFromMd */])(text, {
    count: true
  });
  Object(external_react_["useEffect"])(() => {
    try {
      setTips(`创建于 ${Object(time["a" /* parseDate */])(created, 'YYYY-MM-DD dddd')}, 修改于 ${Object(time["a" /* parseDate */])(modified, 'YYYY-MM-DD dddd')}, 全文字数: ${wordCount}`); // eslint-disable-next-line no-empty
    } catch {}
  ...
  };
  {
    if (weather) {
      actions.informs.push({
        name: weather,
        icon: free_regular_svg_icons_["faSun"]
      });
    }
    ...
    if (mood) {
      actions.informs.push({
        name: mood,
        icon: free_regular_svg_icons_["faSmile"]
      });
    }
    ...
    actions.informs.push({
      ...
      name: Object(time["b" /* relativeTimeFromNow */])(created),
  ...
  return _id_jsx(external_react_default.a.Fragment, null, _id_jsx(SEO["b" /* Seo */], {
    title: title,
    description,
    openGraph: {
      title,
  ...
  }), _id_jsx(NoteLayout["a" /* NoteLayout */], {
    title: title,
    date: new Date(created),
    tips: tips
  }, _id_jsx(MD_render["a" /* default */], {
    value: text,
    escapeHtml: false,
    renderers: {
      text: renderLines
    }
  }), _id_jsx(components_Action, actions), (!!hasNext || !!hasPrev) && _id_jsx("section", {
    className: "paul-more"
  }, !!hasNext && _id_jsx("button", {
    className: "btn green",
    onClick: () => {
...
const getStaticProps = async (context) => {
  ...
  const note = core["a" /* Core */].fetcher.notes.get(id);
  return {
    props: note || {}
  };
};
const getStaticPaths = async () => {
  const paths = core["a" /* Core */].fetcher.notes.getKeys().map(k => {
    return {
      params: {
        id: k
      }
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (NoteView);
